                    ...
                    onEdit: (education) {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => ChangeNotifierProvider.value(
                            value: viewModel,
                            child: EducationFormView(education: education),
                          ),
                        ),
                      );
                    },
                    ...
                    onAdd: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => ChangeNotifierProvider.value(
                            value: viewModel,
                            child: const ExperienceFormView(),
                          ),
                        ),
                      );
                    },
                    onEdit: (experience) {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => ChangeNotifierProvider.value(
                            value: viewModel,
                            child: ExperienceFormView(experience: experience),
                          ),
                        ),
                      );
                    },
                    ...
                    onEdit: (skill) {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => ChangeNotifierProvider.value(
                            value: viewModel,
                            child: SkillFormView(skill: skill),
                          ),
                        ),
                      );
                    },
